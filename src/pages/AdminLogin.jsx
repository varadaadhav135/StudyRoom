    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col selection:bg-amber-100 relative overflow-x-hidden">
            ...
            <div className="flex-1 flex items-center justify-center px-4 pt-44 pb-20 relative">
                ...
                <div className="absolute bottom-0 left-0 -ml-40 -mb-40 w-[600px] h-[600px] bg-red-100/40 rounded-full blur-[120px]"></div>

                <div className="relative w-full max-w-md animate-fade-in-up">
                    <div className="glass-premium p-12 rounded-[3.5rem] border border-white shadow-gold-premium relative bg-white/80">
                        <div className="absolute -top-12 left-1/2 -translate-x-1/2 w-24 h-24 bg-gradient-to-br from-red-600 to-red-800 border-4 border-white rounded-[2rem] flex items-center justify-center shadow-2xl transition-transform hover:scale-110">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            <div className="space-y-3">
                                ...
                                <input
                                    ...
                                    placeholder="admin@dnyanpeeth.com"
                                    disabled={loading}
                                    required
                                />
                            </div>
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full btn-premium bg-gradient-to-r from-red-600 to-red-700 text-white py-5 text-xs font-black uppercase tracking-[0.3em] group shadow-2xl shadow-red-600/30 mt-4 hover:shadow-red-600/50 transition-all"
                            >
                                {loading ? (
                        ...
                        <div className="mt-12 pt-10 border-t border-slate-100 text-center">
                            <p className="text-[9px] text-slate-400 font-black uppercase tracking-[0.5em]">
                                DnyanPeeth Administrative System
                            </p>
                        </div>
                    </div>
                </div>
